...
if (is_shared_mem_sub_ == true){
    // QoS 配置，匹配发布者
    rclcpp::QoS img_qos(rclcpp::KeepLast(1));  // 保留最新一帧
    img_qos.reliability(rclcpp::ReliabilityPolicy::BestEffort);
    img_qos.durability(rclcpp::DurabilityPolicy::Volatile);
